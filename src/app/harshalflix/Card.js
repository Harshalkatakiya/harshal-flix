                    ...
                    <>
                        ...
                        hover:shadow-[0.9em_0.9em_0em] active:!shadow-red-400" key={id}
                            ...
                            <div className='flex-grow flex flex-col mx-3 mt-3  '>
                                ...
                                <a onClick={() => { handleOpenLink(url) }} rel="noreferrer" target="_blank" class="select-none cursor-pointer mt-auto  text-center  text-red-600 transition-all w-fit m-auto my-5 relative px-6 py-3 font-bold  group
